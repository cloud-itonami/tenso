...
(def cell-specs {
  ...
  :post {:legacy-cell "app-bsky-feed-post"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :like {:legacy-cell "app-bsky-feed-like"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "like")]
     :required-gates common-gates
     :trigger "manifest cell like"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :follow {:legacy-cell "app-bsky-graph-follow"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "follow")]
     :required-gates common-gates
     :trigger "manifest cell follow"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :transferrequest {:legacy-cell "com-etzhayyim-apps-tenso-transferRequest"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "transferrequest")]
     :required-gates common-gates
     :trigger "manifest cell transferrequest"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :filemanifest {:legacy-cell "com-etzhayyim-apps-tenso-fileManifest"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "filemanifest")]
     :required-gates common-gates
     :trigger "manifest cell filemanifest"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :transferlog {:legacy-cell "com-etzhayyim-apps-tenso-transferLog"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "transferlog")]
     :required-gates common-gates
     :trigger "manifest cell transferlog"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :accesscontrol {:legacy-cell "com-etzhayyim-apps-tenso-accessControl"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "accesscontrol")]
     :required-gates common-gates
     :trigger "manifest cell accesscontrol"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
